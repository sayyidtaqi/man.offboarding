		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Offboarding",
									"targetURL": "#smmhcmappmanoffboarding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smmhcmappmanoffboarding-display": {
								"semanticObject": "smmhcmappmanoffboarding",
								"action": "display",
								"description": "Fiori OffBoarding",
								"title": "Offboarding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smm.hcmapp.man.offboarding",
									"url": sap.ui.require.toUrl("smm/hcmapp/man/offboarding")
								}
							}
						}
					}
